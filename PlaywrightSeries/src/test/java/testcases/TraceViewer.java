...
public class TraceViewer {
	...
	public static void main(String[] args) {
		...
		/*
		 The Trace Viewer is a debugging tool in Playwright that helps you debug and analyze your test runs by showing a 
		 visual recording of everything that happened during a test.
		 */
